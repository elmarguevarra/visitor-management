...
const USER_POOL_DOMAIN_URL = 'https://alphine-vms-auth.auth.ap-southeast-1.amazoncognito.com'
// const AUTHORITY_URL = 'https://cognito-idp.ap-southeast-1.amazonaws.com/ap-southeast-1_DSpKRdggr'
